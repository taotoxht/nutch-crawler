...
//				System.out.println("model exists!");
    ...
    public boolean loadModel(Configuration conf,String svmModelLexicon,String svmModel) {

        try {
            lexicon.loadFromInputStream(conf.getConfResourceAsInputStream(svmModelLexicon));
            this.lmodel = de.bwaldvogel.liblinear.Linear.loadModel(conf.getConfResourceAsReader(svmModel));
        } catch ( Exception e ) {
            e.printStackTrace();
            return false;
        }
